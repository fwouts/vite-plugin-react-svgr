...
describe("plugin transform", () => {
  const svgFilePath = path.join(__dirname, "react.svg");
  ...
  it("supports custom component name", async () => {
    expect(
      ...
      const ReactComponent = (props) => /* @__PURE__ */ React.createElement(\\"svg\\", {
      ...
      export { ReactComponent as SvgComponent };
      ",
      }
    `);
  });
  ...
  function invokeTransform(...args: ArgumentsType<typeof svgr>) {
    return svgr(...args).transform!.call(null as any, "", svgFilePath);
  }
});
